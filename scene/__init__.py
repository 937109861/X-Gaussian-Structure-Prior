...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel_Xray, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info, self.volume_positions, self.image_3d = sceneLoadTypeCallbacks["Xray"](
                ...
                prior_threshold_mode=args.prior_threshold_mode,
                prior_threshold_value=args.prior_threshold_value,
        ...
        self.init_info = scene_info.init_info or {}
        ...
        for resolution_scale in resolution_scales:
            ...
            self.add_cameras[resolution_scale] = cameraList_from_camInfos(scene_info.add_cameras or [], resolution_scale, args)
